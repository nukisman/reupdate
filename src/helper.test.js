...
describe('Set array', () => {
  test('Contains object', () => {
    ...
    const res = update(state, { $set: nextState });
  ...
  test('Same', () => {
    ...
    const res = update(state, { $set: state });
...
describe('Set object', () => {
  ...
  test('Change part', () => {
    ...
    const res = update(state, { $merge: { wip: false } });
    expect(res).toEqual(nextState);
  ...
  test('Toggle part', () => {
    ...
    const res = update(state, { $toggle: ['wip'] });
    expect(res).toEqual(nextState);
  ...
  test('Delete part', () => {
    ...
    const res = update(state, { $unset: ['wip'] });
    expect(res).toEqual(nextState);
...
describe('Extend object', () => {
  ...
  test('Changed part', () => {
    ...
    const res = update(state, { $merge: ext });
